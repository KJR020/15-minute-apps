...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        logo = QLabel()
        logo.setPixmap(QPixmap(os.path.joint("images", "ma-icon-128.png")))
        ...
        for i in range(0, layout.count()):
            layout.itemAt(i).setAlignment(Qt.AlignHCneter)
...
class MainWindow(QMainWindow):
    ...
    def navigate_mozarella(self):
        self.browser.setUrl(QUrl("https://wwww.udemy.com/522076"))
